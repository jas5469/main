...
public class ParserUtilTest {
    ...
    public void parseTag_validValueWithoutWhitespace_returnsTag() throws Exception {
        Group expectedGroup = new Group(VALID_TAG_1);
        assertEquals(expectedGroup, ParserUtil.parseTag(VALID_TAG_1));
    }
    ...
    public void parseTag_validValueWithWhitespace_returnsTrimmedTag() throws Exception {
        ...
        Group expectedGroup = new Group(VALID_TAG_1);
        assertEquals(expectedGroup, ParserUtil.parseTag(tagWithWhitespace));
    }
    ...
    public void parseTags_collectionWithValidTags_returnsTagSet() throws Exception {
        Set<Group> actualGroupSet = ParserUtil.parseTags(Arrays.asList(VALID_TAG_1, VALID_TAG_2));
        Set<Group> expectedGroupSet = new HashSet<Group>(Arrays.asList(new Group(VALID_TAG_1), new Group(VALID_TAG_2)));
