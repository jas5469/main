...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withTimeTableLink(VALID_TIMETABLE_LINK_AMY).withDetail(VALID_DETAIL_AMY).withGroups(VALID_GROUP_CS1010)
            .build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
            .withTimeTableLink(VALID_TIMETABLE_LINK_BOB).withDetail(VALID_DETAIL_BOB).withGroups(VALID_GROUP_CS2010,
                    VALID_GROUP_CS1010)
            .build();
