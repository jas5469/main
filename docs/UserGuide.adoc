...
=== Change a tag's color: `changeTagColor`

Change a specific tag color to one of the supported colors. +
Alias: `color` +
...
=== Schedule suitable time : `schedule`
